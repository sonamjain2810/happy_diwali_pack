...
// light Appbar text Styling
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    ...
    headline6: GoogleFonts.dancingScript(textStyle: _lightScreenHeading6TextStyle),
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    ...
    headline6: GoogleFonts.architectsDaughter(textStyle: _darkScreenHeading6TextStyle),
 ...
 // Text headline6 styling
  static final TextStyle _darkScreenHeading6TextStyle = _lightScreenHeading6TextStyle.copyWith(
    color: _darkOnPrimaryColor,
  );
