...
class ImageDetailPage extends StatefulWidget {
  String type;
  int index;
  ImageDetailPage( this.index, this.type);
  @override
  _ImageDetailPageState createState() => _ImageDetailPageState(index , type);
}
...
class _ImageDetailPageState extends State<ImageDetailPage> {
  ...
  _ImageDetailPageState(this.index, this.type);
...
//Native Ad Close
  ...
  void onImageDowloadButtonPressed() async {
    var response = await http.get(data[index]);
